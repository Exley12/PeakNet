...
Also the spectra must be normalised i.e max value of 1 (in fact the current model was trained on spectra where the maximum peak value was 0.85)
...
## Insallation
pip install git+https://github.com/Exley12/PeakNet.git
